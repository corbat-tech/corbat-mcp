# Run Benchmark Tests WITHOUT Corbat MCP

## Prerequisites

**IMPORTANT**: Ensure Corbat MCP is NOT active before running these tests.
...
```
# CORBAT BENCHMARK - WITHOUT MCP

Execute the complete benchmark suite. This measures AI code generation quality WITHOUT coding standards injection.

## STEP 0: Clean Previous Results

First, delete any existing results to ensure clean comparison:

rm -rf docs/comparison-tests/results-without-mcp/*

Then create the folder structure:

mkdir -p docs/comparison-tests/results-without-mcp/{typescript,java-spring,react,python}
...
Save to: docs/comparison-tests/results-without-mcp/typescript/test-1-result.ts
...
Save to: docs/comparison-tests/results-without-mcp/typescript/test-2-result.ts
...
Save to: docs/comparison-tests/results-without-mcp/typescript/test-3-result.ts
...
Save to: docs/comparison-tests/results-without-mcp/typescript/test-4-result.ts
...
Save to: docs/comparison-tests/results-without-mcp/typescript/test-5-result.ts
...
Save to: docs/comparison-tests/results-without-mcp/java-spring/test-1-result.java
...
Save to: docs/comparison-tests/results-without-mcp/java-spring/test-2-result.java
...
Save to: docs/comparison-tests/results-without-mcp/java-spring/test-3-result.java
...
Save to: docs/comparison-tests/results-without-mcp/java-spring/test-4-result.java
...
Save to: docs/comparison-tests/results-without-mcp/java-spring/test-5-result.java
...
Save to: docs/comparison-tests/results-without-mcp/react/test-1-result.tsx
...
Save to: docs/comparison-tests/results-without-mcp/react/test-2-result.tsx
...
Save to: docs/comparison-tests/results-without-mcp/react/test-3-result.tsx
...
Save to: docs/comparison-tests/results-without-mcp/react/test-4-result.tsx
...
Save to: docs/comparison-tests/results-without-mcp/react/test-5-result.tsx
...
Save to: docs/comparison-tests/results-without-mcp/python/test-1-result.py
...
Save to: docs/comparison-tests/results-without-mcp/python/test-2-result.py
...
Save to: docs/comparison-tests/results-without-mcp/python/test-3-result.py
...
Save to: docs/comparison-tests/results-without-mcp/python/test-4-result.py
...
Save to: docs/comparison-tests/results-without-mcp/python/test-5-result.py
...
Run the WITH MCP tests: [RUN-TESTS-WITH-MCP.md](./RUN-TESTS-WITH-MCP.md)
